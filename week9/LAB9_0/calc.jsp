...
<body>
	<form name=form1 action="calc_result.jsp" method=post>
   	<table align="center" width="700" height="400">
        ...
        <tr>
            ...
            <td><input style="text-align:center;" type=text name=num1 width=200 size=10 value=0></td>
        </tr>
        <tr>
            <td>
		...
		<tr>
			<td><input style="text-align:center;" type=text name=num2 width=200 size=10 value=0></td>
		</tr>
		<tr>
